...
public  final class UInt64Value extends
    ...
    public static UInt64Value parseFrom(java.io.InputStream input)
    ...
    public static UInt64Value parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static UInt64Value parseDelimitedFrom(
            java.io.InputStream input,
            ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
    ...
    public static final class Builder extends
            GeneratedMessageLite.Builder<
                    UInt64Value, Builder> implements
            ...
            case GET_PARSER: {
                ...
                if (parser == null) {
                    synchronized (UInt64Value.class) {
                        ...
                        if (parser == null) {
                            parser =
                                    new DefaultInstanceBasedParser<UInt64Value>(
                                            DEFAULT_INSTANCE);
                            PARSER = parser;
                        }
                    }
