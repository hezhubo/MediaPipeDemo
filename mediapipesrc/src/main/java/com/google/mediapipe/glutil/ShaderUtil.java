...
//          GLES20.glGetShaderInfoLog(shader));
      Log.i(ShaderUtil.class.getSimpleName(), "Could not compile shader " + shaderType + ": " + GLES20.glGetShaderInfoLog(shader));
...
//      logger.atSevere().log("Could not create program");
      Log.i(ShaderUtil.class.getSimpleName(), "Could not create program");
    }
...
//      logger.atSevere().log("Could not link program: %s", GLES20.glGetProgramInfoLog(program));
      Log.i(ShaderUtil.class.getSimpleName(), "Could not link program: " + GLES20.glGetProgramInfoLog(program));
