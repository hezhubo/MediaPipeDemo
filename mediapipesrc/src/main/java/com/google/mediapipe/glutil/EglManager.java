 ...
 *
 * <p>Note: Since we want to support API level 16, we cannot rely on {@link EGL14}.
 */
public class EglManager {
  ...
  public static final int EGL14_API_LEVEL = Build.VERSION_CODES.JELLY_BEAN_MR1;
  ...
  private void grabContextVariants() {
    ...
    if (Build.VERSION.SDK_INT >= EGL14_API_LEVEL) {
      egl14Context = EGL14.eglGetCurrentContext();
    }
